...
//!
//! Future: teams will have shared sessions (team chat rooms where
//! AI agents participate) and cloud-run sessions (always-on).
...
pub struct Team {
    ...
    pub members: Vec<String>, // user_ids
    pub created_at: String,
}

/// In-memory team store backed by `{data_dir}/teams.json`.
pub struct TeamStore {
    pub teams: HashMap<String, Team>, // team_id -> Team
}
...
async fn create_team(
    ...
    let team = Team {
        ...
        members: vec![auth.user_id.clone()], // creator is first member
